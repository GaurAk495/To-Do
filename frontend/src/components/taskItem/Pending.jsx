...
export default function Pending({ task, method }) {
  ...
  return (
    <motion.li
      ...
      className={`group flex justify-between items-center px-5 py-4 rounded-2xl shadow-md transition-all duration-300 border ${
        isEditing
    ...
    >
        ...
        <AnimatePresence mode="wait">
          {isEditing ? (
            <motion.input
              ...
              className="w-full max-w-[220px] px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white text-gray-800"
      ...
      <div className="flex items-center gap-4">
        <div className={`min-w-[140px] transition-opacity ${!isEditing && 'opacity-60'}`}>
